        ...
        >
          <Command className="bg-transparent text-slate-100 w-full">
            ...
            <CommandList className="max-h-60 overflow-y-auto p-1.5 custom-scrollbar w-full">
              <CommandEmpty className="py-3 px-4 text-xs font-mono text-slate-400 text-center">
                {emptyText}
              </CommandEmpty>
              <CommandGroup>
                {options.map((option) => {
                  ...
                  return (
                    <CommandItem
                      ...
                      className={cn(
                        'flex cursor-pointer select-none items-center rounded-lg px-3 py-2 text-xs font-mono font-medium outline-none transition-colors hover:bg-indigo-600/30 hover:text-cyan-300',
