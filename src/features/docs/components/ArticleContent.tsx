...
export const ArticleContent: React.FC<ArticleContentProps> = ({ post }) => {
  return (
    <article className="glass-card rounded-2xl p-6 sm:p-10 border-slate-800">
      <ArticleHeader post={post} />

      <div
        className="prose prose-invert max-w-none pt-6 text-slate-300 text-sm leading-relaxed
