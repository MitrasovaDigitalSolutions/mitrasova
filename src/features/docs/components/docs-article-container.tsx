...
import { ServiceDocsLeftSidebar } from './service-docs-left-sidebar';
...
export const DocsArticleContainer: React.FC<DocsArticleProps> = ({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 pb-28">
      {/* Top Breadcrumb */}
      <div className="flex items-center gap-2 text-xs text-slate-400 mb-8 overflow-x-auto pb-2 font-mono">
