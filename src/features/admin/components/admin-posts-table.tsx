  ...
  return (
    <GlassCard className="p-6 border-slate-800/90 space-y-4 relative overflow-hidden bg-slate-950/80">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-3 border-b border-slate-800 gap-3">
        <div>
          <h3 className="text-lg font-bold text-white">Daftar Publikasi (Blog, Berita, & Events)</h3>
          <p className="text-xs text-slate-400">Total {INITIAL_POSTS.length} konten aktif di sistem</p>
        </div>
        <Link
          href="/console/posts/new"
          className="text-xs text-cyan-400 font-mono font-semibold hover:text-cyan-300 inline-flex items-center gap-1 bg-cyan-500/10 px-3 py-1.5 rounded-lg border border-cyan-500/20 w-fit"
        >
